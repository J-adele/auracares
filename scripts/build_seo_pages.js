...
${bank.questions.slice(0,500).map(q=>`  <url><loc>https://kedicare.netlify.app/seo-q/${q.seoSlug}.html</loc><changefreq>monthly</changefreq><priority>0.6</priority></url>`).join('\n')}
</urlset>`;
